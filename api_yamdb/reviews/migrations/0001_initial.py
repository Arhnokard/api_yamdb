# Generated by Django 3.2 on 2023-04-15 14:01
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.SlugField(unique=True, verbose_name='Сокращенное название категории')),
            ],
        ),
        migrations.CreateModel(
            name='Genre',
            fields=[
                ...
                ('slug', models.SlugField(unique=True, verbose_name='Сокращенное название жанра')),
            ],
        ),
        migrations.CreateModel(
            name='GenreTitle',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rating', models.IntegerField(verbose_name='Рейтинг приозведения')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('score', models.IntegerField(validators=[django.core.validators.MaxValueValidator(10, 'Оценка может быть от 1 до 10'), django.core.validators.MinValueValidator(1, 'Оценка  может быть от 1 до 10')])),
                ('pub_date', models.TimeField(auto_now_add=True, verbose_name='Дата отзыва')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('text', models.TextField()),
                ('pub_date', models.TimeField(auto_now_add=True, verbose_name='Дата комментария')),
